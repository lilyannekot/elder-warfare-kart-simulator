...
const Instructions = () => {
  ...
  return (
    <div className="instructions">
      ...
      <h4>
        You have HP and attack stats, your attack stat modifies the damage your
        abilities do.
      </h4>
      <h4>
        After combat, you are taken to a store page where you can choose to buy
        items for the next battle.
      </h4>
